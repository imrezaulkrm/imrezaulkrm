...
-   Designed a scalable microservices architecture with containerized services.
-   Implemented GitOps using ArgoCD for declarative and automated application management.
-   Automated CD with Jenkins CI/CD, utilizing multibranch pipelines and GitHub webhooks.
-   Managed Kubernetes infrastructure, including deployments, storage (NFS), and networking (Ingress, Services).
-   Currently integrating CI to enhance automation and maintain code quality.
